...
**nf-core/demultiplex** is a bioinformatics pipeline used to demultiplex the raw data produced by next generation sequencing machines. At present, Illumina and Singular Genomics sequencing data is supported.
...
- [fqtk](#fqtk) - demultiplexing bgzipped fastq files produced by Singular Genomics (CONDITIONAL)
- [sgdemux](#sgdemux) - demultiplexing fastq files (CONDITIONAL)
